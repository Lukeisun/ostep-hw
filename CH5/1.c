...
/*
* Changing  x in either process will not affect the result to either Parent or Child
* As when fork is called the new process is given its own address space
